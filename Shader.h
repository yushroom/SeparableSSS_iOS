...
public:
    ...
    void init(const std::string vert_prog_path, const std::string frag_prog_path)
    {
        init(vert_prog_path.c_str(), frag_prog_path.c_str());
    }
...
public:
	...
	{
		draw_texture.init("shader/Quad.vert", "shader/Quad.frag");
	}

	static Shader draw_texture;
	//static Shader head_shader("shader/TransformVertexShader.vert", "shader/TextureFragmentShader.frag");
	//static Shader skyDome_shader("shader/main.vert", "shader/main.frag");
