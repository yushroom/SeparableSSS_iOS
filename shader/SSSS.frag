...
#define SSSS_STREGTH_SOURCE (SSSSSample(strengthTex, texcoord).a)
#endif
 ...
 */
uniform float4 kernel[SSSS_N_SAMPLES]; 
#else
/**
...
void main()
{
	out_color = SSSSBlurPS(uv, colorTex, depthTex, sssWidth, dir, init_stencil);
}
